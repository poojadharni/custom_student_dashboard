<template>
  <button class="flex h-7 cursor-pointer items-center rounded
         duration-300 ease-in-out
         focus:outline-none
         focus:transition-none
         focus-visible:rounded
         focus-visible:ring-2
         focus-visible:ring-[#C8499A]
         text-gray-800" :class="isActive
          ? 'bg-[#C8499A] text-white shadow-sm'
          : 'hover:bg-[#C8499A] hover:text-white'
          " @click="handleClick">
